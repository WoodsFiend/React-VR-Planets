...
export default class Space extends React.Component {
    constructor(){
        super();
        this.state = {planetName:"", zoom:0.2, message:"  ", button:{Sun:"#0009",Mercury:"#0009",Venus:"#0009",Mars:"#0009",Jupiter:"#0009",Saturn:"#0009",Uranus:"#0009",Neptune:"#0009"}};
    ...
    handleClick(string){
        ...
        this.setState({button:{Sun:"#0009",Mercury:"#0009",Venus:"#0009",Mars:"#0009",Jupiter:"#0009",Saturn:"#0009",Uranus:"#0009",Neptune:"#0009"}});
        this.setState({button:{Sun:"#9000"}});
    }
    handleClickPlanet(){
      ...
      <View>
        ...
        <View style={{width:1, flexDirection:'row', transform: [{translate: [-4,-1,-5]}],}}>
            ...
            <VrButton onClick={this.handleClick.bind(this,"Sun")}>
                <Text style={{
                    backgroundColor: this.state.button["Sun"],
                    fontSize: 0.2,
                    fontWeight: '400',
            ...
            <VrButton onClick={this.handleClick.bind(this,"Mercury")}>
                <Text style={{
                    backgroundColor: this.state.button["Mercury"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Venus")}>
                <Text style={{
                    backgroundColor: this.state.button["Venus"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Mars")}>
                <Text style={{
                    backgroundColor: this.state.button["Mars"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Jupiter")}>
                <Text style={{
                    backgroundColor: this.state.button["Jupiter"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Saturn")}>
                <Text style={{
                    backgroundColor: this.state.button["Saturn"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Uranus")}>
                <Text style={{
                    backgroundColor: this.state.button["Uranus"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
            ...
            <VrButton onClick={this.handleClick.bind(this,"Neptune")}>
                <Text style={{
                    backgroundColor: this.state.button["Neptune"],
                    fontSize: 0.2,
                    fontWeight: '400',
                    layoutOrigin: [0.5, 0.5],
                    paddingLeft: 0.3,
